...
public class TransactionView extends Model{
	...
	private static final String DATABASE_CREATE = "CREATE VIEW " 
				...
				+ ExpenseParentCategory.TABLE_EXPENSE_PARENT_CATEGORY +"."+ExpenseParentCategory.COLUMN_NAME
				+ " AS "+COLUMN_EXPENSE_CATEGORY_PARENT_NAME+", "
				+ ExpenseChildCategory.TABLE_EXPENSE_CHILD_CATEGORY +"."+ExpenseChildCategory.COLUMN_NAME
				...
				+" INNER JOIN "+ExpenseChildCategory.TABLE_EXPENSE_CHILD_CATEGORY
				+ " ON "+TransactionTable.TABLE_TRANSACTION+"."+TransactionTable.COLUMN_EXPENSE_CATEGORY_ID+" = "+ExpenseChildCategory.TABLE_EXPENSE_CHILD_CATEGORY +"."+ExpenseChildCategory.COLUMN_ID
				+" INNER JOIN "+ExpenseParentCategory.TABLE_EXPENSE_PARENT_CATEGORY
				+ " ON "+ExpenseChildCategory.TABLE_EXPENSE_CHILD_CATEGORY+"."+ExpenseChildCategory.COLUMN_EXPENSE_PARENT_CATEGORY_ID+" = "+ExpenseParentCategory.TABLE_EXPENSE_PARENT_CATEGORY +"."+ExpenseParentCategory.COLUMN_ID
				;
